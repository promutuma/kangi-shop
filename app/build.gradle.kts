...
android {
    ...
    defaultConfig {
        applicationId = "ke.eelaminnovations.kangaishop"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
    ...
    productFlavors {
        create("dev") {
            ...
            buildConfigField("String", "FIREBASE_PROJECT", "\"kangai-shop-dev\"")
            buildConfigField("boolean", "DEBUG_MODE", "true")
        }
        create("prod") {
            dimension = "environment"
            buildConfigField("String", "FIREBASE_PROJECT", "\"kangai-shop\"")
