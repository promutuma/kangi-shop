...
class RecordGoodsUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        val transaction = LedgerTransaction(
            ...
            personId = personId,
            type = TransactionType.GOODS_ON_CREDIT,
        ...
        withContext(Dispatchers.IO) {
            try {
                ...
                if (globalSms && person != null && person.smsEnabled) {
                    ...
                    val message = SmsHelper.buildGoodsMessage(shopName, amount, newBalance, transaction.transactionDate)
